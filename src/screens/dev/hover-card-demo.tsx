  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs text-fg-muted">
        @mention user profile (Avatar + bio + follower count、本文 inline trigger)
      </p>
...
function LinkPreviewCard() {
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs text-fg-muted">
        link preview (header image + URL + title + 説明、p-0 で flush layout)
      </p>
      <p className="text-sm leading-relaxed text-fg-soft">
...
function InlineHelpCard() {
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs text-fg-muted">
        inline help (info icon、Arrow + ArrowTip で trigger を指す、placement=top)
      </p>
