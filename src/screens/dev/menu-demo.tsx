  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs text-fg-muted">
        edit menu (Item + shortcut + disabled + destructive (赤 Delete))
      </p>
      <div>
        <Menu.Root>
...
function ShareMenu() {
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs text-fg-muted">
        share with submenu (Menu.Root を nest して TriggerItem で submenu を開く、
        ⋯ icon button)
      </p>
      <div>
        <Menu.Root>
...
function ViewOptionsMenu() {
  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs text-fg-muted">
        view options (ItemGroup + Label で section、 RadioItemGroup (排他) +
        CheckboxItem (複数選択)、 closeOnSelect=false で 開きっぱなし)
      </p>
      <div>
