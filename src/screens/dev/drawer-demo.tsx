  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs text-fg-muted">
        right (default、 swipeDirection=end、 Settings / Cart 用、 Title + body +
        footer)
      </p>
      <div>
        <Drawer.Root>
...
function LeftMobileNav() {
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs text-fg-muted">
        left (swipeDirection=start、 mobile nav drawer 用、 nav list)
      </p>
      <div>
...
function BottomSheet() {
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs text-fg-muted">
        bottom sheet (swipeDirection=up、 Grabber + GrabberIndicator で iOS 風、
        スワイプダウンで閉じる)
      </p>
      <div>
