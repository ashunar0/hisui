...
export function ScrollAreaDoc() {
  return (
    <div className="flex flex-col gap-10">
      <DocHeader title="ScrollArea">
        custom scrollbar をかぶせるための wrapper。 native scrollbar を hide して
        Thumb を上書き描画するので、 OS によらず統一された見た目になる。
        Root に高さを与えるのが基本。
      </DocHeader>

      <DocSection
        title="Anatomy"
        description="Root → Viewport → Content の入れ子と、 Scrollbar + Thumb の組み合わせが必須。"
      >
      ...
      <DocSection
        title="Vertical"
        description="Root に h-N で高さを当てて、 中身が溢れた分だけ scroll。"
      >
        <Example
  ...
  <ScrollArea.Scrollbar orientation="vertical">
    <ScrollArea.Thumb />
      ...
      <DocSection
        title="Horizontal"
        description="Content を w-max + flex-row にして横に伸ばす。 Scrollbar orientation=horizontal。"
      >
        <Example
  ...
  <ScrollArea.Scrollbar orientation="horizontal">
    <ScrollArea.Thumb />
      ...
      <DocSection
        title="Both axes"
        description="Scrollbar を 2 つ + Corner を置くと両軸 scroll の右下が綺麗に埋まる。 大きい table に。"
      >
        <Example
